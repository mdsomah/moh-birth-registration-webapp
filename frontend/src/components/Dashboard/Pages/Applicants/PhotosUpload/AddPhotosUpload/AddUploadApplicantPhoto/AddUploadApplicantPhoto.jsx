...
const AddUploadApplicantPhoto = ({
  ...
  const handleCancel = () => {
    handleClose();
    formikApplicantForm.setFieldValue("applicantPhoto", "");
    setFiles([]);
  };

  const onDrop = useCallback(
    (acceptedFiles) => {
      formikApplicantForm.setFieldValue("applicantPhoto", acceptedFiles[0]);
      setFiles(
              ...
              <Box {...getRootProps({ style })}>
                <input
                  ...
                  error={
                    ...
                    Boolean(formikApplicantForm.errors.applicantPhoto)
                  }
                />
...
export default React.memo(AddUploadApplicantPhoto);

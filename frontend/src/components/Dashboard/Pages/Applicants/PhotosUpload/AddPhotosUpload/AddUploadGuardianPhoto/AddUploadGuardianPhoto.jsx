...
const AddUploadGuardianPhoto = ({ open, handleClose, formikApplicantForm }) => {
  ...
  const handleCancel = () => {
    handleClose();
    formikApplicantForm.setFieldValue("parentOrGuardianPhoto", "");
    setFiles([]);
  };
              ...
              <Box {...getRootProps({ style })}>
                <input
                  ...
                  error={
                    ...
                    Boolean(formikApplicantForm.errors.parentOrGuardianPhoto)
                  }
                />
...
export default React.memo(AddUploadGuardianPhoto);

...
const ChangeProfilePasswordDialog = ({ open, handleClose }) => {
              ...
              >
                ...
                <FormControl fullWidth>
                  ...
                  <OutlinedInput
                    ...
                    value={formikUserProfilePasswordForm.values.confirmPassword}
                    onChange={formikUserProfilePasswordForm.handleChange}
                    onBlur={formikUserProfilePasswordForm.handleBlur}
                  />
                  <Typography
...
export default React.memo(ChangeProfilePasswordDialog);
